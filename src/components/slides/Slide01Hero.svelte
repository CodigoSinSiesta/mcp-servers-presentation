...
<div class="swiper-slide" bind:this={slideElement}>
  ...
  <div class="slide-content">
    <div class="eyebrow">
      ...
      <span>Códigos sin Siesta · 2026</span>
    </div>

    <h1 class="title">
      Tu nueva<br />
      <span class="highlight">herramienta</span><br />
      <span class="highlight-servers">MCP Servers</span>
    </h1>

    <p class="subtitle">
      Conecta tu IA con el mundo exterior.<br />
      Construye herramientas reales en minutos.
    </p>

    <div class="tools-row">
      <span class="tool-badge">Model Context Protocol</span>
      <span class="tool-badge">TypeScript</span>
      <span class="tool-badge">Python</span>
      <span class="tool-badge highlight-badge">FastMCP</span>
    </div>
